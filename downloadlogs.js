// This tampermonkey script has been modified to automatically download instead of waiting for a key
...
{   //variables you might actually want to change
    ...
    function parse(record)
    {
        ...
        if (VERBOSELOG)
        {
            ...
            /// ashlen modification, mjshead is the only relevant part
            // res["mjslog"]         = mjslog;
    ...
    async function waitForSceneAndDownload() {
        while (!(checkscene(uiscript.UI_Replay) || checkscene(uiscript.UI_Loading))) {
            console.log("waiting")
